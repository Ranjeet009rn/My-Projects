...
<head>
    ...
    <title>@Vishwaurja</title>
    <link rel="canonical" href="https://ld-wt73.template-help.com" />
...
<body>
    ...
    <div class="page text-center">
                        ...
                        <div class="rd-navbar-inner">
                            <div class="rd-navbar-top-panel">
                                <div class="left-side">
                                    <ul class="rd-navbar-top-links list-unstyled">
                                        <li><a class="text-uppercase text-ubold" href="login.aspx"><small>Log in</small></a></li>
                                        <li><a class="text-uppercase text-ubold" href="login.aspx"><small>Register</small></a></li>
                                    </ul>
                                </div>
                                <div class="right-side">
                                    <address class="contact-info text-left">
                                        <div class="p"><span class="icon novi-icon mdi mdi-email-open"></span><a href="mailto:#">info@demolink.org</a></div>
                                        <div class="p"><span class="icon novi-icon mdi mdi-phone"></span><a href="tel:#">+91-9881795500</a></div>
                                    </address>
                                </div>
                            </div>
                            <!-- RD Navbar Panel-->
                            <div class="rd-navbar-panel">
                                ...
                                <div class="rd-navbar-brand">
                                    <a href="Default.aspx">
                                        <img width='217' height='36' src='images/logo-dark.png' alt='' /></a>
                                </div>
                            </div>
                                ...
                                <div class="rd-navbar-nav-wrap">
                                    <div class="rd-navbar-mobile-scroll">
                                        ...
                                        <ul class="rd-navbar-nav">
                                            ...
                                            <li><a href="catalog.aspx"><span>Catalog</span></a></li>
                                            <li><a href="submit-property.aspx"><span>Submit Property</span></a></li>
        ...
        <!--Section Search form-->
        <!-- Swiper CSS (add this to your <head> if not already included) -->
        ...
        <section class="section context-dark">
            <div class="swiper-container swiper-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide" data-slide-bg="images/slide-01-1920x640.jpg"></div>
                    <div class="swiper-slide" data-slide-bg="images/slide-02-1920x640.jpg"></div>
                    <div class="swiper-slide" data-slide-bg="images/slide-03-1920x640.jpg"></div>
                </div>
                                                    ...
                                                    <div class="group-sm group-top">
                                                        <div class="group-item element-fullwidth" style="max-width: 390px">
                                                            <div class="form-group">
                                                                <label class="form-label" for="home-tabs1-search">Search by City or Address:</label>
                                                                <input class="form-control" id="home-tabs1-search" type="text" name="s" autocomplete="off">
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="offset-lg-top-10">
                                                <form>
                                                    <div class="group-sm group-top">
                                                        <div class="group-item element-fullwidth" style="max-width: 390px">
                                                            <div class="form-group">
                                                                <label class="form-label" for="home-tabs2-search">Search by Address or City:</label>
                                                                <input class="form-control" id="home-tabs2-search" type="text" name="s" autocomplete="off">
                                                            </div>
                                                        </div>
                                                        <button class="btn btn-primary element-fullwidth" type="button" style="max-width: 120px">search</button>
                                                    </div>
                                            ...
                                            <div class="offset-lg-top-10">
                                                <form>
                                                    <div class="group-sm group-top">
                                                        <div class="group-item element-fullwidth" style="max-width: 390px">
                                                            <div class="form-group">
                                                                <label class="form-label" for="home-tabs3-search">Search by City or Address:</label>
                                                                <input class="form-control" id="home-tabs3-search" type="text" name="s" autocomplete="off">
                                                            </div>
                                                        </div>
                                                        <button class="btn btn-primary element-fullwidth" type="button" style="max-width: 120px">search</button>
                                                    </div>
        ...
        <!-- Swiper JS and Initialization Script (place before </body>) -->
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        <section class="section section-34 novi-background" data-preset='{"title":"Properties 1","category":"properties","reload":false,"id":"properties-1"}'>
                ...
                <div class="row row-30 justify-content-sm-center">
                    <div class="col-sm-8 col-md-6 col-xl-3">
                        ...
                        <figure class="thumbnail-terry">
                            <a href="#">
                                <img width="442" height="280" src="images/home-img-01-442-280.jpg" alt=""></a>
                            <figcaption>
                                <div>
                                    <h4 class="thumbnail-terry-title">With Swimming Pool </h4>
                                </div>
                                <p class="thumbnail-terry-desc offset-top-0">32 properties</p>
                                <a class="btn offset-top-10 offset-md-top-0 btn-primary" href="catalog.aspx">choose an apartment</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="col-sm-8 col-md-6 col-xl-3">
                        ...
                        <figure class="thumbnail-terry">
                            <a href="#">
                                <img width="442" height="280" src="images/home-img-02-442-280.jpg" alt=""></a>
                            <figcaption>
                                <div>
                                    <h4 class="thumbnail-terry-title">Cozy Houses</h4>
                                </div>
                                <p class="thumbnail-terry-desc offset-top-0">54 properties</p>
                                <a class="btn offset-top-10 offset-md-top-0 btn-primary" href="catalog.aspx">choose an apartment</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="col-sm-8 col-md-6 col-xl-3">
                        ...
                        <figure class="thumbnail-terry">
                            <a href="#">
                                <img width="442" height="280" src="images/home-img-03-442-280.jpg" alt=""></a>
                            <figcaption>
                                <div>
                    ...
                    <div class="col-sm-8 col-md-6 col-xl-3">
                        ...
                        <figure class="thumbnail-terry">
                            <a href="#">
                                <img width="442" height="280" src="images/home-img-04-442-280.jpg" alt=""></a>
                            <figcaption>
                                <div>
                                    <h4 class="thumbnail-terry-title">Luxury Houses</h4>
                                </div>
                                <p class="thumbnail-terry-desc offset-top-0">19 properties</p>
                                <a class="btn offset-top-10 offset-md-top-0 btn-primary" href="catalog.aspx">choose an apartment</a>
                            </figcaption>
                        </figure>
                    </div>
        ...
        <section class="section section-bottom-98 section-top-34 section-lg-bottom-110 section-lg-top-66 bg-default novi-background" data-preset='{"title":"Properties 2","category":"properties","reload":false,"id":"properties-2"}'>
            <div class="container">
                <h2 class="font-weight-bold">Recent Properties</h2>
                <hr class="divider bg-saffron">
                <div class="row row-65">
                    <div class="col-md-6 col-lg-4">
                        <img class="img-fluid d-inline-block" src="images/home-img-05-370x250.jpg" width="370" height="250" alt="">
                        <div class="text-md-left offset-top-24">
                            <div>
                                <h5 class="font-weight-bold text-primary"><a href="single-property-page.aspx">AVA Nob Hill</a></h5>
                            </div>
                            <h6 class="offset-top-10">$1199.00/mon</h6>
                            <ul class="list-inline list-inline-sm list-inline-dotted text-dark">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <img class="img-fluid d-inline-block" src="images/home-img-06-370x250.jpg" width="370" height="250" alt="">
                        <div class="text-md-left offset-top-24">
                            <div>
                                <h5 class="font-weight-bold text-primary"><a href="single-property-page.aspx">Ashton San Francisco</a></h5>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <img class="img-fluid d-inline-block" src="images/home-img-07-370x250.jpg" width="370" height="250" alt="">
                        <div class="text-md-left offset-top-24">
                            <div>
                                <h5 class="font-weight-bold text-primary"><a href="single-property-page.aspx">The Presidio Residences</a></h5>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <img class="img-fluid d-inline-block" src="images/home-img-08-370x250.jpg" width="370" height="250" alt="">
                        <div class="text-md-left offset-top-24">
                            <div>
                                <h5 class="font-weight-bold text-primary"><a href="single-property-page.aspx">Alchemy by Alta</a></h5>
                            </div>
                            <h6 class="offset-top-10">$1199.00/mon</h6>
                            <ul class="list-inline list-inline-sm list-inline-dotted text-dark">
                                <li class="list-inline-item">1200 sq ft</li>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <img class="img-fluid d-inline-block" src="images/home-img-09-370x250.jpg" width="370" height="250" alt="">
                        <div class="text-md-left offset-top-24">
                            <div>
                                <h5 class="font-weight-bold text-primary"><a href="single-property-page.aspx">Avalon at Mission Bay</a></h5>
                            </div>
                            <h6 class="offset-top-10">$1595.00/mon</h6>
                            <ul class="list-inline list-inline-sm list-inline-dotted text-dark">
                                <li class="list-inline-item">1200 sq ft</li>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <img class="img-fluid d-inline-block" src="images/home-img-10-370x250.jpg" width="370" height="250" alt="">
                        <div class="text-md-left offset-top-24">
                            <div>
                                <h5 class="font-weight-bold text-primary"><a href="single-property-page.aspx">Bayside Village Apartments</a></h5>
                            </div>
                            <h6 class="offset-top-10">$2699.00/mon</h6>
                            <ul class="list-inline list-inline-sm list-inline-dotted text-dark">
                                <li class="list-inline-item">2200 sq ft</li>
                ...
                <div class="offset-top-50"><a class="btn btn-primary" href="catalog.aspx">view all properties</a></div>
            </div>
        </section>
        <!--Section Real Estate Tools and Resources-->
        <section class="section context-dark" data-preset='{"title":"Services","category":"about","reload":true,"id":"services"}'>
            <div class="parallax-container" data-parallax-img="images/bg-01-1920x768.jpg">
                <div class="parallax-content">
                    <div class="container section-98 section-md-110">
                        ...
                        <hr class="divider bg-saffron">
                        <div class="row row-65 justify-content-sm-center offset-top-66">
                            <div class="col-md-4">
                                <!-- Icon Box Type 4-->
                                <span class="icon novi-icon novi-bg-color icon-circle mdi mdi-comment-text-outline icon-carrot-filled"></span>
                            ...
                            <div class="col-md-4">
                                <!-- Icon Box Type 4-->
                                <span class="icon novi-icon novi-bg-color icon-circle mdi mdi-star icon-carrot-filled"></span>
                            ...
                            <div class="col-md-4">
                                <!-- Icon Box Type 4-->
                                <span class="icon novi-icon novi-bg-color icon-circle mdi mdi-domain icon-carrot-filled"></span>
        ...
        <section class="section section-98 section-lg-110 bg-default novi-background" data-preset='{"title":"Team","category":"team","reload":false,"id":"team"}'>
            <div class="container">
                <h2 class="font-weight-bold">Real Estate Agents</h2>
                <hr class="divider bg-saffron">
                <div class="row row-50 justify-content-sm-center offset-top-66">
                    <div class="col-md-6 col-lg-3">
                        <div class="member-block-type-6">
                            <img class="img-fluid d-inline-block" src="images/users/user-ashley-mason-270x270.jpg" alt="" width="270" height="270">
                            <div class="text-left offset-top-20">
                                <div>
                                    <h5 class="font-weight-bold text-primary"><a href="team-member.aspx">Ashley Mason</a></h5>
                                </div>
                            </div>
                            <address class="contact-info text-left">
                                <ul class="list-unstyled p">
                                    <li class="d-block"><span class="icon novi-icon icon-xxs mdi mdi-phone text-middle"></span><a class="d-inline-block text-middle" href="tel:#">1-800-7650-986</a>
                                    </li>
                                    <li class="d-block"><span class="icon novi-icon icon-xxs mdi mdi-email-open text-middle"></span><a class="d-inline-block text-middle" href="mailto:#">info@demolink.org</a>
                                    </li>
                                </ul>
                            </address>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="member-block-type-6">
                            <img class="img-fluid d-inline-block" src="images/users/user-russel-myers-270x270.jpg" alt="" width="270" height="270">
                            <div class="text-left offset-top-20">
                                <div>
                                    <h5 class="font-weight-bold text-primary"><a href="team-member.axpx">Russell Myers</a></h5>
                                </div>
                            </div>
                            <address class="contact-info text-left">
                                <ul class="list-unstyled p">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="member-block-type-6">
                            <img class="img-fluid d-inline-block" src="images/users/user-shirley-vasques-270x270.jpg" alt="" width="270" height="270">
                            <div class="text-left offset-top-20">
                                <div>
                                    <h5 class="font-weight-bold text-primary"><a href="team-member.aspx">Shirley Vasquez</a></h5>
                                </div>
                            </div>
                            <address class="contact-info text-left">
                                <ul class="list-unstyled p">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="member-block-type-6">
                            <img class="img-fluid d-inline-block" src="images/users/user-terry-sandoval-270x270.jpg" alt="" width="270" height="270">
                            <div class="text-left offset-top-20">
                                <div>
                                    <h5 class="font-weight-bold text-primary"><a href="team-member.aspx">Terry Sandoval</a></h5>
                                </div>
                            </div>
                            <address class="contact-info text-left">
                                <ul class="list-unstyled p">
                ...
                <div class="offset-top-66">
                    <a class="btn btn-primary" href="about.aspx">view all agents</a>
                </div>

            </div>
        </section>
        <!--Section Testimonials-->
        <section class="section section-98 section-lg-110 bg-lighter novi-background" data-preset='{"title":"Testimonials","category":"team","reload":true,"id":"testimonials"}'>
            <div class="container">
                <h2 class="font-weight-bold">Testimonials</h2>
                <hr class="divider bg-saffron">
                <div class="offset-top-66">
                    <!-- Testimonials Slider v.4-->
                    <div class="owl-carousel owl-carousel-classic owl-carousel-class-light veil-owl-nav owl-carousel-testimonials-3" data-items="1" data-md-items="2" data-lg-items="3" data-xl-items="3" data-nav="false" data-dots="true" data-margin="50px">
                        <div>
                            <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                                <div class="unit-left">
                                    <img class="quote-img rounded-circle" width="80" height="80" src="images/users/user-lisa-evans-80x80.jpg" alt="Lisa Evans">
                                </div>
                        ...
                        <div>
                            <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                                <div class="unit-left">
                                    <img class="quote-img rounded-circle" width="80" height="80" src="images/users/user-nicholas-lane-80x80.jpg" alt="Nicholas Lane">
                                </div>
                                <div class="unit-body text-left">
                                    <div>
                                        <p>
                                    ...
                                    <p class="font-weight-bold quote-                                        <cite class="text-normal">Nicholas Lane</cite>
                                    </p>
                                </div>
                            </blockquote>
                        </div>
                        <div>
                            <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                                <div class="unit-left">
                                    <img class="quote-img rounded-circle" width="80" height="80" src="images/users/user-ethan-dean-80x80.jpg" alt="Ethan Dean">
                                </div>
                                <div class="unit-body text-left">
                                    <div>
                                        <p>
        ...
        <!--Section Real Estate Tools and Resources-->
        <section class="section context-dark" data-preset='{"title":"Contact form 1","category":"contacts","reload":true,"id":"contact-form-1"}'>
                ...
                <div class="parallax-content">
                    <div class="container section-98 section-md-110">
                        ...
                        <div class="row row-fix justify-content-sm-center offset-top-66">
                            <div class="col-md-8">
                                <!-- RD Mailform -->
                                <form class="rd-mailform rd-form text-left"
                                    data-form-output="form-output-global"
                                    data-form-type="contact"
                                    method="post"
                                    action="/bat/rd-mailform.aspx">
                                    <div class="row row-25 row-fix">
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                <label class="form-label" for="real-estate-first-name">First name:</label>
                                                <input class="form-control" id="real-estate-first-name" type="text" name="name" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                <label class="form-label" for="real-estate-last-name">Last name:</label>
                                                <input class="form-control" id="real-estate-last-name" type="text" name="last_name" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                <label class="form-label" for="real-estate-phone">Phone:</label>
                                                <input class="form-control" id="real-estate-phone" type="tel" name="phone" pattern="[0-9]+" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                <label class="form-label" for="real-estate-mail">E-mail:</label>
                                                <input class="form-control" id="real-estate-mail" type="email" name="email" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-12 offset-top-24">
                                            <div class="form-group">
                                                <label class="form-label" for="contact-me-message">Message:</label>
                                                <textarea class="form-control" id="contact-me-message" name="message" required style="height: 150px"></textarea>
                                            </div>
                                        </div>
                                    </div>
        ...
        <footer class="section section-relative section-top-66 section-bottom-34 page-footer bg-gray-base context-dark novi-background" data-preset='{"title":"Footer","category":"main","reload":true,"id":"footer"}'>
                        ...
                        <div class="row row-50 justify-content-sm-center">
                            <div class="col-sm-12 col-xl-3">
                                ...
                                <div class="footer-brand">
                                    <a href="Default.aspx">
                                        <img src="/images/logo-light.png" width="170" height="30" alt="Logo">
                                    </a>
                                </div>
                            ...
                            <div class="col-sm-12 col-lg-5 text-lg-left col-xl-4">
                                ...
                                <div class="offset-top-30">
                                    <form class="rd-mailform rd-form" data-form-output="form-subscribe-footer" data-form-type="subscribe" method="post" action="bat/rd-mailform.aspx">
                                        <div class="form-output" id="form-subscribe-footer"></div>
                                        <div class="form-group">
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-prepend"><span class="input-group-text input-group-icon"><span class="form-icon mdi mdi-email novi-icon"></span></span></span>
                                    ...
                                    <article class="post widget-post text-left">
                                        <a href="#">
                                            <div class="unit flex-row unit-spacing-xs align-items-center">
                                                <div class="unit-body">
                                                    <div class="post-meta">
                                                        <span class="icon-xxs novi-icon text-primary mdi mdi-arrow-right"></span>
            ...
            <div class="container offset-top-50">
                <p class="small text-darker">Intense Real Estate &copy; <span id="copyright-year"></span>. <a href="privacy.aspx">Privacy Policy</a></p>
            </div>
        </footer>
    </div>
    <a class="builder-button" href="https://ld-wp2.template-help.com/novi-builder/intense-real-estate/" target="_blank">
        <img src="images/novi-icon-26x26.png" width="26" height="26" alt=""><span>Try builder</span></a>
