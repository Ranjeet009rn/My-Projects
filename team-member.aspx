...
<head>
    ...
    <link rel="canonical" href="https://ld-wt73.template-help.com/intense/intense-real-estate/team-member.aspx" />
...
<body>
    ...
    <div class="page text-center">
        <!-- Page Head-->
        <a href="team-member.aspx">team-member.aspx</a>
                    ...
                    <div class="container">
                        <div class="rd-navbar-inner">
                            ...
                            <div class="rd-navbar-panel">
                                ...
                                <!--Navbar Brand-->
                                <div class="rd-navbar-brand"><a href="../../Default.aspx">
                                    <img width='217' height='36' src='/images/logo-dark.png' alt='' /></a></div>
                            </div>
                                ...
                                <div class="rd-navbar-nav-wrap">
                                    <div class="rd-navbar-mobile-scroll">
                                        ...
                                        <ul class="rd-navbar-nav">
                                            ...
                                            <li><a href="/catalog.aspx"><span>Catalog</span></a>
                                            </li>
                                            <li><a href="/submit-property.aspx"><span>Submit Property</span></a>
                                            </li>
                                            <li><a href="/services.aspx"><span>Services</span></a>
                                            </li>
                                            <li class="active"><a href="/about.aspx"><span>About</span></a>
                                            </li>
                ...
                <div class="parallax-content">
                    <div class="container section-top-34 section-md-top-98 section-bottom-34">
                        ...
                        <ul class="list-inline list-inline-dashed p text-light breadcrumb-modern offset-top-10 offset-md-top-66">
                            <li class="list-inline-item"><a href="../../Default.aspx">Home</a></li>
                            <li class="list-inline-item"><a href="/about.aspx">About</a></li>
                            <li class="list-inline-item">Team member</li>
                        </ul>
                    </div>
                </div>
            </div>
        </section>
        <!--Section Shirley Vasquez-->
        <section class="section section-98 section-md-110 bg-lighter novi-background" data-preset='{"title":"Team member","category":"team","reload":false,"id":"team-member"}'>
            <div class="container">
                <h3 class="font-weight-bold">Shirley Vasquez</h3>
                <hr class="divider bg-saffron">
                <div class="offset-md-top-66">
                    <div class="row row-40 row-fix">
                        <div class="col-md-4">
                            <img class="img-fluid d-inline-block" src="/images/users/user-shirley-vasques-370x370.jpg" width="370" height="370" alt=""><a class="btn btn-block btn-primary offset-top-34 d-inline-block" href="/submit-property.aspx" style="max-width: 370px">make an appointment</a>
                            <div class="offset-top-34">
                                <address class="contact-info text-lg-left">
                                    <ul class="list-unstyled p">
                                        ...
                                        <li class="d-block"><span class="icon novi-icon icon-xxs mdi mdi-email-open text-middle"></span><a class="d-inline-block text-middle" href="mailto:russell@demolink.org">russell@demolink.org</a>
                                        </li>
                                    </ul>
                                </address>
                            </div>
                            ...
                            <div class="inset-lg-left-50">
                                <div class="row row-40">
                                    <div class="col-6 col-lg-4">
                                        <div class="unit flex-md-row unit-spacing-xs">
                                            <div class="unit-left"><span class="icon novi-icon icon-sm mdi mdi-clipboard-check text-mantis"></span></div>
                                            <div class="unit-body text-md-left">
                                                <div>
                                                    <h2 class="font-weight-bold">582</h2>
                                                </div>
                                    ...
                                    <div class="col-6 col-lg-4">
                                        <div class="unit flex-md-row unit-spacing-xs">
                                            <div class="unit-left"><span class="icon novi-icon icon-sm mdi mdi-domain text-malibu"></span></div>
                                            <div class="unit-body text-md-left">
                                                <div>
                                                    <h2 class="font-weight-bold">1844</h2>
                                                </div>
                                ...
                                <div class="text-left offset-top-50">
                                    <p>With a strong background and many years of experience in interior design, Shirley is renowned in the industry for her dedicated, honest, and forward approach, winning the confidence of clients quickly and establishing successful working relations.</p>
                                    <p>Ms. Vasquez has a solid reputation of a professional who is an approachable and trustworthy real estate agent. She understands the importance of building long-term relationships and has a genuine passion for helping people achieve their real estate goals and expectations. Since Shirley has joined our team, her skills acquired during her work as a remodeling expert helped her a lot in her current work as a real estate agent and property manager. She knows every single detail of the house or apartment she offers. Moreover, Shirley can give you additional support or advice on selecting a home just for you.</p>
                                    <p>Vasquez always desired to work in the company that would care about the place where modern citizens live. Now she is confident that her current job is an ideal place to improve her communication skills and professional development as a real estate agent while being a part of a solid team.</p>
                                    <p>Shirley Vasquez is more than just an agent for our company. With every house sold and property managed, she tries to achieve a higher level of real estate services provided on behalf of Intense agency. Her contribution to the development of our company can hardly be overestimated.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!--Section Filter Form-->
        <section class="section section-98 section-md-110 bg-default novi-background" data-preset='{"title":"Properties 4","category":"properties","reload":true,"id":"properties-4"}'>
            <div class="container">
                <h3 class="font-weight-bold">Shirley Vasquez’s Properties</h3>
                <hr class="divider bg-saffron">
                <div class="offset-md-top-66">
                    <div class="row row-65 row-fix justify-content-sm-center">
                        <div class="col-sm-10 col-md-6 col-lg-4 order-lg-2">
                            <!-- RD Mailform-->
                            <form class="rd-form text-left bg-lighter well-lg novi-background">
                                <h5 class="font-weight-bold">Properties Filter</h5>
                                ...
                                <div class="row row-20 row-fix offset-top-20">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-label form-label-outside" for="form-filter-min-bath">Min Bath:</label>
                                ...
                                <div class="form-group-multiple offset-top-20">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control bg-white" id="form-filter-price-from" type="text" name="phone" data-constraints="@Required">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label form-label-outside" for="form-filter-price-to">&nbsp;<span class="d-md-none">Price to (USD):</span></label>
                                        <input class="form-control bg-white" id="form-filter-price-to" type="text" name="phone" data-constraints="@Required">
                                    </div>
                                </div>
                                <div class="form-group-multiple offset-top-20">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control bg-white" id="form-filter-area-from" type="text" name="phone" data-constraints="@Required">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label form-label-outside" for="form-filter-area-to">&nbsp;<span class="d-md-none">Area to (Sq Ft):</span></label>
                                        <input class="form-control bg-white" id="form-filter-area-to" type="text" name="phone" data-constraints="@Required">
                                    </div>
                                </div>
                    ...
                    <div class="col-md-8 col-lg-12">
                        <div class="row row-50 justify-content-sm-center">
                            <div class="col-sm-12 col-xl-3">
                                <!-- Footer brand-->
                                <div class="footer-brand"><a href="../../Default.aspx">
                                    <img width='170' height='30' src='/images/logo-light.png' alt='' /></a></div>
