...
<head>
    ...
    <title>About</title>
    <link rel="canonical" href="https://ld-wt73.template-help.com/intense/intense-real-estate/about.aspx" />
                ...
                <div class="offset-md-top-66">
                    ...
                    <div class="responsive-tabs responsive-tabs-classic" data-type="horizontal">
                        ...
                        <div class="resp-tabs-container tabs-group-default" data-group="tabs-group-default">
                            <div>
                                <div class="row row-30 section-34">
                                    <div class="col-lg-5">
                                        <img class="img-fluid d-inline-block" src="/images/about-01-470x310.jpg" width="470" height="310" alt=""></div>
                            ...
                            <div>
                                <div class="row row-30 row-fix justify-content-sm-center section-34">
                                    <div class="col-lg-3 text-lg-left">
                                        <img class="img-fluid d-inline-block" src="/images/users/user-carl-bishop-270x270.jpg" width="270" height="270" alt="">
                                        ...
                                        <div class="offset-top-14">
                                            <ul class="list-unstyled p">
                                                ...
                                                <li class="d-block"><span class="icon novi-icon icon-xxs mdi mdi-email-open text-middle"></span><a class="d-inline-block text-middle" href="mailto:carlbishop@demolink.org">carlbishop@demolink.org</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <div class="row row-50 justify-content-sm-center section-34">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="member-block-type-6">
                                            ...
                                            <div class="text-left offset-top-20">
                                                <div>
                                                    <h5 class="font-weight-bold text-primary"><a href="/team-member.aspx">Russell Myers</a></h5>
                                                </div>
                                            </div>
                                            <address class="contact-info text-left">
                                                <ul class="list-unstyled p">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="member-block-type-6">
                                            <img class="img-fluid d-inline-block" src="/images/users/user-randy-shneider-270x270.jpg" alt="" width="270" height="270">
                                            <div class="text-left offset-top-20">
                                                <div>
                                                    <h5 class="font-weight-bold text-primary"><a href="/team-member.aspx">Randy Schneider</a></h5>
                                                </div>
                                            </div>
                                            <address class="contact-info text-left">
                                                <ul class="list-unstyled p">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="member-block-type-6">
                                            <img class="img-fluid d-inline-block" src="/images/users/user-olivia-marshall-270x270.jpg" alt="" width="270" height="270">
                                            <div class="text-left offset-top-20">
                                                <div>
                                                    <h5 class="font-weight-bold text-primary"><a href="/team-member.aspx">Olivia Marshall</a></h5>
                                                </div>
                                            </div>
                                            <address class="contact-info text-left">
                                                <ul class="list-unstyled p">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="member-block-type-6">
                                            <img class="img-fluid d-inline-block" src="/images/users/user-samanta-nelson-270x270.jpg" alt="" width="270" height="270">
                                            <div class="text-left offset-top-20">
                                                <div>
                                                    <h5 class="font-weight-bold text-primary"><a href="/team-member.aspx">Samantha Nelson</a></h5>
                                                </div>
                                            </div>
                                            <address class="contact-info text-left">
                                                <ul class="list-unstyled p">
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="member-block-type-6">
                                            <img class="img-fluid d-inline-block" src="/images/users/user-maria-george-270x270.jpg" alt="" width="270" height="270">
                                            <div class="text-left offset-top-20">
                                                <div>
                                                    <h5 class="font-weight-bold text-primary"><a href="/team-member.aspx">Maria George</a></h5>
                                                </div>
                                            </div>
                                            <address class="contact-info text-left">
                                                <ul class="list-unstyled p">
                            ...
                            <div>
                                <div class="row row-50 section-34">
                                    <div class="col-md-6 col-lg-4">
                                        <blockquote class="quote quote-slider-4 unit unit-spacing-sm flex-md-row">
                                            <div class="unit-left">
                                                <img class="quote-img rounded-circle" width="80" height="80" src="/images/users/user-lisa-evans-80x80.jpg" alt=""></div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <blockquote class="quote quote-slider-4 unit unit-spacing-sm flex-md-row">
                                            <div class="unit-left">
                                                <img class="quote-img rounded-circle" width="80" height="80" src="/images/users/user-nicholas-lane-80x80.jpg" alt=""></div>
                                            <div class="unit-body text-left">
                                                <div>
                                                    <p>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <blockquote class="quote quote-slider-4 unit unit-spacing-sm flex-md-row">
                                            <div class="unit-left">
                                                <img class="quote-img rounded-circle" width="80" height="80" src="/images/users/user-ethan-dean-80x80.jpg" alt=""></div>
                                            <div class="unit-body text-left">
                                                <div>
                                                    <p>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <blockquote class="quote quote-slider-4 unit unit-spacing-sm flex-md-row">
                                            <div class="unit-left">
                                                <img class="quote-img rounded-circle" width="80" height="80" src="/images/users/user-pamela-hansen-80x80.jpg" alt=""></div>
                                            <div class="unit-body text-left">
                                                <div>
                                                    <p>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <blockquote class="quote quote-slider-4 unit unit-spacing-sm flex-md-row">
                                            <div class="unit-left">
                                                <img class="quote-img rounded-circle" width="80" height="80" src="/images/users/user-donald-webb-80x80.jpg" alt=""></div>
                                            <div class="unit-body text-left">
                                                <div>
                                                    <p>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <blockquote class="quote quote-slider-4 unit unit-spacing-sm flex-md-row">
                                            <div class="unit-left">
                                                <img class="quote-img rounded-circle" width="80" height="80" src="/images/users/user-donna-keller-80x80.jpg" alt=""></div>
                                            <div class="unit-body text-left">
                                                <div>
                                                    <p>
